...
export function Header() {
  ...
  return (
    <header className="border-b-card-bg w-full border">
      <div className="mx-10 grid grid-cols-[1fr_minmax(260px,520px)_1fr] items-center gap-4 px-4 py-3">
        <h1 className="text-primary justify-self-start text-[18px] font-bold">
          Mini Twitter
        </h1>

        <div className="text-secondary-400 border-card-bg focus-within:border-secondary-400 flex items-center gap-2 rounded-md border bg-white px-4 py-2">
          <IconeLupa />
          <input
            type="text"
